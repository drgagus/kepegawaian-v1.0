          ...
          <div class="container mb-5">
            ...
            <div class="row pt-3" style="background:#ffffff">
              <div class="col-lg-12">
                <h5 class="mb-3">EDIT</h5>
                <?= $this->session->flashdata('message'); ?>

              <?= form_open_multipart('pegawai/edit_file/'.$filebyid['file_id']); ?>

              <div class="form-group">
                  <input type="text" class="form-control" id="judulfile" name="judulfile" value="<?= $filebyid['judul']; ?>">
                ...
                <div class="form-group">
                   <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="berkas"><?= $filebyid['file']; ?></label>
                  ...
                  <table class="table table-hover" style="background:#ffff;">
                    ...
                    <?php if ($files) : ?>
                      ...
                      <tr>
                        ...
                        <td class="text-right"><a href="<?= base_url('pegawai/edit_file/').$file['file_id']; ?>" class="badge badge-warning" >edit</a>
