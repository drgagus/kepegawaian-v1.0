        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
              ...
              <p class="lead">Anda Login Sebagai GUEST</p>
            </div>
          </div>
          ...
          <div class="container-fluid mb-5">
            <div class="row">
              <div class="col-lg-12">
              <!-- <a href="<?= base_url('auth/logout');?>" class="btn btn-danger mb-4 ml-2" data-toggle="modal" data-target="#logoutModal">Logout</a> -->
              <div class="btn-group dropright">
                <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Menu</button>
                <div class="dropdown-menu">
                  <a class="dropdown-item" target="_blank" href="<?= base_url('guest/convert_excel');?>">Convert to Excel</a>
                  <a class="dropdown-item" target="_blank" href="<?= base_url('guest/convert_pdf');?>">Convert to Pdf</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item text-danger font-weight-bold" data-toggle="modal" data-target="#logoutModal" href="<?= base_url('auth/logout');?>">Logout</a>
                </div>
              </div>
